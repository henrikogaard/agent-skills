...
| [`delegated-subagents`](delegated-subagents/SKILL.md) | Delegation | Opt-in delegation of bounded repository work to external OpenCode or Devin CLI workers while Codex remains the supervising coordinator. |
